    ...
    render() {
        return (
            <Container fluid={true} className="pt-3 pb-4">
                ...
                <Form.Control type="text" placeholder="Protagonistas (separar por comas)" value={this.props.pelicula.protagonistas} onChange={e => this.props.setProtagonistas(e.target.value)} />
            </Container>
        );
    }
}
