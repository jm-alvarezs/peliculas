import { PELICULAS_RECEIVED, SEARCH_PELICULAS, SET_PELICULA, SET_NOMBRE_PELICULA, SET_DIRECTOR_PELICULA, SET_CATEGORIA_PELICULA, SET_PROTAGONISTAS_PELICULA, SET_MODAL } from "../actions/types";
